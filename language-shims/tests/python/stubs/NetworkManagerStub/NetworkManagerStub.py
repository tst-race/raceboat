...
from networkManagerPluginBindings import (
    ByteVector,
    EncPkg,
    IRacePluginNetworkManager,
    IRaceSdkNetworkManager,
    IRaceSdkApp,
    LinkProperties,
    ChannelProperties,
    CHANNEL_AVAILABLE,
...
class PluginNetworkManagerTwoSixPy(IRacePluginNetworkManager):
    """
    A NetworkManager stub
    """

    def __init__(self, sdk: IRaceSdkNetworkManager):
        """ """
        super().__init__()
