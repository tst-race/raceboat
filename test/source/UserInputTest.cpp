...
TEST(UserInputTest, test) {
  ...
  std::string startPort =
      *input.getPluginUserInput("PluginCommsTwoSixStub", "startPort");
  std::string endPort =
      *input.getPluginUserInput("PluginCommsTwoSixStub", "endPort");
  ...
  std::optional<std::string> invalid2 =
      input.getPluginUserInput("invalid", "startPort");
