...
public:
    ApiManagerSendTestFixture() : params(), core(std::make_shared<MockCore>()), manager(*core) {
    ...
    void expectActivateChannel(RaceHandle &handle,
    ...
    void sendCall(std::function<void(ApiStatus)> callback, std::string send_address = "");
...
void ApiManagerSendTestFixture::expectActivateChannel(RaceHandle &handle,
                                                      ActivateChannelStatusCode status) {
...
void ApiManagerSendTestFixture::expectLoadLinkAddress(RaceHandle &handle,
...
void ApiManagerSendTestFixture::expectOpenConnection(RaceHandle &handle, ConnectionID thisConnId) {
    EXPECT_CALL(*core->plugin, openConnection(_, linkProps.linkType, thisConnId, "{}", 0, 0, _))
...
void ApiManagerSendTestFixture::expectSendPackage(RaceHandle &handle, ConnectionID thisConnId) {
...
void ApiManagerSendTestFixture::expectCloseConnection(RaceHandle &handle, ConnectionID thisConnId) {
...
void ApiManagerSendTestFixture::expectDestroyLink(RaceHandle &handle, LinkID thisLinkId) {
...
void ApiManagerSendTestFixture::sendCall(std::function<void(ApiStatus)> callback,
                                         std::string send_address) {
...
void ApiManagerSendTestFixture::onChannelStatusChangedCall(RaceHandle handle) {
    manager.onChannelStatusChanged(*core->container, handle, sendOptions.send_channel,
                                   CHANNEL_AVAILABLE, channelProps);
    manager.waitForCallbacks();
}

void ApiManagerSendTestFixture::onLinkStatusChangedCall(RaceHandle handle, LinkID thisLinkId) {
    manager.onLinkStatusChanged(*core->container, handle, thisLinkId, LINK_LOADED, linkProps);
    manager.waitForCallbacks();
}

void ApiManagerSendTestFixture::onConnectionStatusChangedCall(RaceHandle handle,
...
void ApiManagerSendTestFixture::onConnectionStatusChangedClosedCall(RaceHandle handle,
                                                                    ConnectionID thisConnId) {
...
void ApiManagerSendTestFixture::onLinkStatusChangedDestroyedCall(RaceHandle handle,
                                                                 LinkID thisLinkId) {
...
TEST_F(ApiManagerSendTestFixture, multiple_sends_interleaved_no_errors) {
    ...
    expectActivateChannel(chanHandle2, ActivateChannelStatusCode::ALREADY_ACTIVATED);
...
TEST_F(ApiManagerSendTestFixture, onChannelStatusChanged_error) {
    ...
    manager.onChannelStatusChanged(*core->container, chanHandle, sendOptions.send_channel,
                                   CHANNEL_FAILED, {});
...
TEST_F(ApiManagerSendTestFixture, onLinkStatusChanged_error) {
    ...
    onChannelStatusChangedCall(chanHandle);
    manager.onLinkStatusChanged(*core->container, loadLinkHandle, linkId, LINK_DESTROYED,
                                linkProps);
...
TEST_F(ApiManagerSendTestFixture, openConnection_error) {
    expectActivateChannel(chanHandle);
    expectLoadLinkAddress(loadLinkHandle);
    EXPECT_CALL(*core->plugin, openConnection(_, linkProps.linkType, linkId, "{}", 0, 0, _))
...
TEST_F(ApiManagerSendTestFixture, DISABLED_onConnectionStatusChanged_closed_error) {
    expectActivateChannel(chanHandle);
    expectLoadLinkAddress(loadLinkHandle);
    expectOpenConnection(openConnHandle, linkId);
    expectSendPackage(pkgHandle, connId);
    ...
    // manager.onConnectionStatusChanged(*core->container, closeConnHandle, connId,
    // CONNECTION_CLOSED,
    //                                   linkProps);
...
TEST_F(ApiManagerSendTestFixture, DISABLED_onLinkStatusChanged_destroyed_error) {
    expectActivateChannel(chanHandle);
    expectLoadLinkAddress(loadLinkHandle);
    expectOpenConnection(openConnHandle, linkId);
    expectSendPackage(pkgHandle, connId);
...
TEST_F(ApiManagerSendTestFixture, multiple_onConnectionStatusChangedClosed_calls) {
    expectActivateChannel(chanHandle);
    expectLoadLinkAddress(loadLinkHandle);
    expectOpenConnection(openConnHandle, linkId);
    expectSendPackage(pkgHandle, connId);
