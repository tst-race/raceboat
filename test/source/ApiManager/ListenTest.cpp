...
void ApiManagerListenTestFixture::expectActivateSendChannel(
...
void ApiManagerListenTestFixture::expectActivateRecvChannel(
    RaceHandle &handle, ActivateChannelStatusCode thisStatus) {
  EXPECT_CALL(
      core->mockChannelManager,
...
void ApiManagerListenTestFixture::expectLoadLinkAddress(
    RaceHandle &handle, std::string send_address) {
  EXPECT_CALL(*core->plugin,
              loadLinkAddress(_, recvOptions.send_channel, send_address, _))
...
void ApiManagerListenTestFixture::expectOpenConnection(
...
void ApiManagerListenTestFixture::expectSendPackage(RaceHandle &handle,
                                                    ConnectionID thisConnId) {
...
void ApiManagerListenTestFixture::expectCloseConnection(
    RaceHandle &handle, ConnectionID thisConnId) {
...
void ApiManagerListenTestFixture::expectDestroyLink(RaceHandle &handle,
                                                    LinkID thisLinkId) {
...
void ApiManagerListenTestFixture::writeCall(
    RaceHandle handle, std::function<void(ApiStatus)> callback) {
  manager.write(handle, sendBytes, callback);
  manager.waitForCallbacks();
}

void ApiManagerListenTestFixture::closeCall(
    RaceHandle handle, std::function<void(ApiStatus)> callback) {
  manager.close(handle, callback);
  manager.waitForCallbacks();
}

void ApiManagerListenTestFixture::onChannelStatusChangedCall(
...
void ApiManagerListenTestFixture::onLinkStatusChangedCall(RaceHandle handle,
                                                          LinkID thisLinkId) {
...
void ApiManagerListenTestFixture::onConnectionStatusChangedCall(
    RaceHandle handle, ConnectionID thisConnId) {
...
void ApiManagerListenTestFixture::onPackageStatusChangedCall(
    RaceHandle handle) {
...
void ApiManagerListenTestFixture::onConnectionStatusChangedClosedCall(
    RaceHandle handle, ConnectionID thisConnId) {
  manager.onConnectionStatusChanged(*core->container, handle, thisConnId,
...
void ApiManagerListenTestFixture::onLinkStatusChangedDestroyedCall(
...
TEST_F(ApiManagerListenTestFixture, open_send_link_fail) {
  ...
  manager.onChannelStatusChanged(*core->container, sendChanHandle,
                                 recvOptions.send_channel, CHANNEL_FAILED,
                                 channelProps);
