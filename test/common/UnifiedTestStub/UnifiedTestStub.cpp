...
PluginResponse UnifiedTestStub::init(const PluginConfig &pluginConfig) {
  ...
  RaceLog::logDebug("DecomposedStub",
                    "pluginConfig.etcDirectory: " + pluginConfig.etcDirectory,
                    "");
  RaceLog::logDebug(
      "DecomposedStub",
  ...
  RaceLog::logDebug("DecomposedStub",
                    "pluginConfig.tmpDirectory: " + pluginConfig.tmpDirectory,
                    "");
  return PLUGIN_OK;
}

PluginResponse UnifiedTestStub::shutdown() { return PLUGIN_OK; }

PluginResponse UnifiedTestStub::sendPackage(RaceHandle, ConnectionID, EncPkg,
                                            double, uint64_t) {
  return PLUGIN_OK;
}

PluginResponse UnifiedTestStub::openConnection(RaceHandle, LinkType, LinkID,
                                               std::string, int32_t) {
  return PLUGIN_OK;
}
...
PluginResponse UnifiedTestStub::loadLinkAddress(RaceHandle, std::string,
                                                std::string) {
  return PLUGIN_OK;
}
...
PluginResponse UnifiedTestStub::createLinkFromAddress(RaceHandle, std::string,
                                                      std::string) {
  return PLUGIN_OK;
}

PluginResponse UnifiedTestStub::activateChannel(RaceHandle, std::string,
                                                std::string) {
  return PLUGIN_OK;
}
...
PluginResponse UnifiedTestStub::onUserInputReceived(RaceHandle, bool,
                                                    const std::string &) {
  return PLUGIN_OK;
}
...
PluginResponse UnifiedTestStub::createBootstrapLink(RaceHandle, std::string,
                                                    std::string) {
  return PLUGIN_OK;
}
...
PluginResponse UnifiedTestStub::flushChannel(RaceHandle, std::string,
                                             uint64_t) {
  return PLUGIN_OK;
}
...
const char *const racePluginDescription =
    "Stub plugin for testing loading of unified plugins";