...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/android/arm64-v8a/bin',
 'BINLIBDEST': '/android/arm64-v8a/lib/python3.7',
 'BLDLIBRARY': '-L. -lpython3.7m',
 'BLDSHARED': 'aarch64-linux-android29-clang -shared '
              '-R/data/data/com.twosix.race/python3.7/lib-dynload '
              '-L/android/arm64-v8a/lib/ -lffi '
              '-R/data/data/com.twosix.race/python3.7/lib-dynload '
              '-L/android/arm64-v8a/lib/ -lffi',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-R/data/data/com.twosix.race/python3.7/lib-dynload '
                      '-L/android/arm64-v8a/lib/ -lffi',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/android/arm64-v8a' "
                "'LDFLAGS=-R/data/data/com.twosix.race/python3.7/lib-dynload "
                "-L/android/arm64-v8a/lib/ -lffi' "
                "'HAVE_X509_VERIFY_PARAM_SET1_HOST' "
                "'--host=x86_64-linux-android' '--build=x86_64-pc-linux-gnu' "
                "'--target=aarch64-linux-android' '--enable-shared' "
                "'--disable-ipv6' '--with-system-ffi' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=x86_64-linux-android' "
                "'target_alias=aarch64-linux-android' "
                "'CC=aarch64-linux-android29-clang' 'CFLAGS=-fPIC'",
 'CONFINCLUDEDIR': '/android/arm64-v8a/include',
 'CONFINCLUDEPY': '/android/arm64-v8a/include/python3.7m',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16/coverage.info',
 'COVERAGE_REPORT': '/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'aarch64-linux-android29-clang++',
 'DESTDIRS': '/android/arm64-v8a /android/arm64-v8a/lib '
             '/android/arm64-v8a/lib/python3.7 '
             '/android/arm64-v8a/lib/python3.7/lib-dynload',
 'DESTLIB': '/android/arm64-v8a/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/android/arm64-v8a/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/android/arm64-v8a/include /android/arm64-v8a/include '
                   '/android/arm64-v8a/include/python3.7m '
                   '/android/arm64-v8a/include/python3.7m',
 'INCLUDEDIR': '/android/arm64-v8a/include',
 'INCLUDEPY': '/android/arm64-v8a/include/python3.7m',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'aarch64-linux-android29-clang++ -shared',
 'LDFLAGS': '-R/data/data/com.twosix.race/python3.7/lib-dynload '
            '-L/android/arm64-v8a/lib/ -lffi '
            '-R/data/data/com.twosix.race/python3.7/lib-dynload '
            '-L/android/arm64-v8a/lib/ -lffi',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'aarch64-linux-android29-clang -shared '
             '-R/data/data/com.twosix.race/python3.7/lib-dynload '
             '-L/android/arm64-v8a/lib/ -lffi '
             '-R/data/data/com.twosix.race/python3.7/lib-dynload '
             '-L/android/arm64-v8a/lib/ -lffi',
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/android/arm64-v8a/lib/python3.7',
 'LIBDIR': '/android/arm64-v8a/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/android/arm64-v8a/lib/pkgconfig',
 'LIBPL': '/android/arm64-v8a/lib/python3.7/config-3.7m',
 'LIBRARY': 'libpython3.7m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-ldl',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'aarch64-linux-android29-clang',
 'LINKFORSHARED': '-pie -Xlinker -export-dynamic',
 'LIPO_32BIT_FLAGS': '',
 'LLVM_PROF_ERR': 'no',
 'LLVM_PROF_FILE': 'LLVM_PROFILE_FILE="code-%p.profclangr"',
 'LLVM_PROF_MERGER': '/opt/android/ndk/default/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-profdata '
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/android/arm64-v8a/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'aarch64-linux-android29-clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/android/arm64-v8a/share/man',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_LDFLAGS': '-R/data/data/com.twosix.race/python3.7/lib-dynload '
                    '-L/android/arm64-v8a/lib/ -lffi '
                    '-R/data/data/com.twosix.race/python3.7/lib-dynload '
                    '-L/android/arm64-v8a/lib/ -lffi',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-R/data/data/com.twosix.race/python3.7/lib-dynload '
               '-L/android/arm64-v8a/lib/ -lffi '
               '-R/data/data/com.twosix.race/python3.7/lib-dynload '
               '-L/android/arm64-v8a/lib/ -lffi',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/android/arm64-v8a/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 ...
 'abs_builddir': '/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16',
 'abs_srcdir': '/build/cache/python/3.7.16-3/android-arm64-v8a/source/Python-3.7.16',
 'datarootdir': '/android/arm64-v8a/share',
 'exec_prefix': '/android/arm64-v8a',
