...
/**
 * @brief The SdkWrapper wraps calls into the library core and provides the id
 * of the calling plugin. See the documentation for IRaceSdkCommon and
 * IRaceSdkComms for details about each of the calls.
 *
 */
...
public:
  ...
  virtual SdkResponse asyncError(RaceHandle handle,
                                 PluginResponse status) override;
  virtual ChannelProperties
  getChannelProperties(std::string channelGid) override;
