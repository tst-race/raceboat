...
public:
    ...
    virtual void updateSendReceive(const SendOptions & /* sendOptions */,
                                   std::vector<uint8_t> && /* data */,
    ...
    virtual void updateGetReceiver(
        ...
        std::function<void(ApiStatus, LinkAddress, RaceHandle)> /* cb */){};
    virtual void updateReceive(RaceHandle /* handle */,
                               std::function<void(ApiStatus, std::vector<uint8_t>)> /* cb */){};
    virtual void updateRead(RaceHandle /* handle */,
                            std::function<void(ApiStatus, std::vector<uint8_t>)> /* cb */){};
    virtual void updateWrite(RaceHandle /* handle */, std::vector<uint8_t>,
                             std::function<void(ApiStatus)> /* cb */){};
    virtual void updateClose(RaceHandle /* handle */, std::function<void(ApiStatus)> /* cb */){};

    virtual void updateChannelStatusChanged(RaceHandle /* chanHandle */,
    ...
    virtual void updateConnectionStatusChanged(RaceHandle /* connHandle */,
    ...
    virtual void updateConnStateMachineStart(RaceHandle /* contextHandle */,
                                             ...
                                             std::string /* linkAddress */, bool /* sending */){};
    ...
    virtual void updateListenAccept(std::function<void(ApiStatus, RaceHandle)> /* cb */) {}
...
struct BaseApiState : public State {
