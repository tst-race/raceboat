...
public:
  ...
  // override;
  virtual void
  updateChannelStatusChanged(RaceHandle chanHandle, const ChannelId &channelGid,
                             ChannelStatus status,
                             const ChannelProperties &properties) override;
  virtual void
  updateLinkStatusChanged(RaceHandle linkHandle, const LinkID &linkId,
                          LinkStatus status,
  ...
  virtual void updateConnectionStatusChanged(
      ...
      ConnectionStatus status, const LinkProperties &properties) override;
