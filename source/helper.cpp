...
void helper::logDebug(const std::string &message,
                      const std::string &stackTrace) {
  RaceLog::logDebug(pluginNameForLogging, message, stackTrace);
}

void helper::logInfo(const std::string &message,
                     const std::string &stackTrace) {
  RaceLog::logInfo(pluginNameForLogging, message, stackTrace);
}

void helper::logWarning(const std::string &message,
                        const std::string &stackTrace) {
  RaceLog::logWarning(pluginNameForLogging, message, stackTrace);
}

void helper::logError(const std::string &message,
                      const std::string &stackTrace) {
...
void helper::set_thread_name(const std::string &name) { thread_name = name; }

std::string helper::get_thread_name() { return thread_name; }
