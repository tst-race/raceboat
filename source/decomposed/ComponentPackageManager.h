...
public:
  ...
  getPackageHandlesForAction(CMTypes::ActionInfo *actionInfo);
...
public:
  std::unordered_map<CMTypes::EncodingHandle, CMTypes::EncodingInfo *>
      pendingEncodings;
...
protected:
  ...
  // when onPackageStatusChanged gets called.
  std::unordered_map<CMTypes::PackageFragmentHandle,
