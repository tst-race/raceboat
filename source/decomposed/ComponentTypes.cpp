...
std::string
encodingParametersToString(const EncodingParameters &encodingParameters) {
  return "EncodingParameters{ linkId: " + encodingParameters.linkId +
         ", type: " + encodingParameters.type + ", encodePackage: " +
         std::to_string(encodingParameters.encodePackage) +
         ", json: " + encodingParameters.json + "}";
}

std::ostream &operator<<(std::ostream &out,
                         const EncodingParameters &encodingParameters) {
  return out << encodingParametersToString(encodingParameters);
}

std::string eventToString(const Event & /* event */) { return "Event{}"; }
...
std::string
linkParametersToString(const LinkParameters & /* linkParameters */) {
  return "LinkParameters{}";
}

std::ostream &operator<<(std::ostream &out,
                         const LinkParameters &linkParameters) {
  return out << linkParametersToString(linkParameters);
}

std::string
encodingPropertiesToString(const EncodingProperties &encodingProperties) {
  return "EncodingProperties{ encodingTime: " +
         std::to_string(encodingProperties.encodingTime) +
         ", type: " + encodingProperties.type + "}";
}

std::ostream &operator<<(std::ostream &out,
                         const EncodingProperties &encodingProperties) {
...
std::string specificEncodingPropertiesToString(
  ...
  return "EncodingProperties{ maxBytes: " +
         std::to_string(encodingProperties.maxBytes) + "}";
}
...
std::string
transportPropertiesToString(const TransportProperties &transportProperties) {
  std::stringstream ss;
  ss << "{";
...
std::ostream &operator<<(std::ostream &out,
                         const TransportProperties &transportProperties) {
  return out << transportPropertiesToString(transportProperties);
}

std::string
userModelPropertiesToString(const UserModelProperties &userModelProperties) {
  return "UserModelProperties{ timelineLength: " +
         std::to_string(userModelProperties.timelineLength) +
         ",  timelineFetchPeriod: " +
         std::to_string(userModelProperties.timelineFetchPeriod) + "}";
}

std::ostream &operator<<(std::ostream &out,
                         const UserModelProperties &userModelProperties) {
