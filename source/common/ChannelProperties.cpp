...
template <typename T>
static bool parseField(const nlohmann::json &config, T &dest, const std::string &fieldName,
...
static bool parseLinkPropertySet(const nlohmann::json &propsJson, const std::string &fieldName,
...
static bool parseLinkPropertyPair(const nlohmann::json &propsJson, const std::string &fieldName,
                                  LinkPropertyPair &pair, const std::string &channelGid) {
    try {
        bool success = true;
...
static bool parseRoles(const nlohmann::json &propsJson, std::vector<ChannelRole> &roles,
                       const std::string &fieldName, const std::string &channelGid) {
    bool success = true;
    try {
...
void from_json(const nlohmann::json &j, ChannelProperties &props) {
    ...
    try {
        ...
        success &= parseField(j, props.isFlushable, "isFlushable", props.channelGid);
        success &= parseField(j, props.mtu, "mtu", props.channelGid);
        success &= parseField(j, props.multiAddressable, "multiAddressable", props.channelGid);
        ...
        success &= parseField(j, props.supported_hints, "supported_hints", props.channelGid);
        success &= parseField(j, props.maxLinks, "maxLinks", props.channelGid);
        success &= parseField(j, props.creatorsPerLoader, "creatorsPerLoader", props.channelGid);
        success &= parseField(j, props.loadersPerCreator, "loadersPerCreator", props.channelGid);
        success &=
            parseLinkPropertyPair(j, "creatorExpected", props.creatorExpected, props.channelGid);
        success &=
            parseLinkPropertyPair(j, "loaderExpected", props.loaderExpected, props.channelGid);
        ...
        success &=
            parseField(j, props.maxSendsPerInterval, "maxSendsPerInterval", props.channelGid);
        success &= parseField(j, props.secondsPerInterval, "secondsPerInterval", props.channelGid);
        success &= parseField(j, props.intervalEndTime, "intervalEndTime", props.channelGid);
        success &= parseField(j, props.sendsRemainingInInterval, "sendsRemainingInInterval",
                              props.channelGid);
