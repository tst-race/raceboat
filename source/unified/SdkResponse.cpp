...
SdkResponse::SdkResponse(SdkStatus _status)
    : SdkResponse(_status, 0.0, NULL_RACE_HANDLE) {}
SdkResponse::SdkResponse(SdkStatus _status, double _queueUtilization,
                         RaceHandle _handle) {
  // can't use initializers because these are in the c-compatible base class
