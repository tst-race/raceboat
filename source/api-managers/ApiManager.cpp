...
SdkResponse ApiManager::post(const std::string &logPrefix, T &&function, Args &&... args) {
...
SdkResponse ApiManager::send(SendOptions sendOptions, std::vector<uint8_t> data,
    ...
    return post(logPrefix, &ApiManagerInternal::send, sendOptions, data, callback);
}

SdkResponse ApiManager::sendReceive(SendOptions sendOptions, std::vector<uint8_t> data,
    ...
    return post(logPrefix, &ApiManagerInternal::sendReceive, sendOptions, data, callback);
}

SdkResponse ApiManager::dial(SendOptions sendOptions, std::vector<uint8_t> data,
    ...
    return post(logPrefix, &ApiManagerInternal::dial, sendOptions, data, callback);
}

SdkResponse ApiManager::getReceiveObject(
    ReceiveOptions recvOptions, std::function<void(ApiStatus, LinkAddress, RaceHandle)> callback) {
    TRACE_METHOD();
    ...
    return post(logPrefix, &ApiManagerInternal::getReceiveObject, recvOptions, callback);
}

SdkResponse ApiManager::receive(OpHandle handle,
                                std::function<void(ApiStatus, std::vector<uint8_t>)> callback) {
    TRACE_METHOD();
...
SdkResponse ApiManager::receiveRespond(
    OpHandle handle, std::function<void(ApiStatus, std::vector<uint8_t>, LinkAddress)> callback) {
    TRACE_METHOD();
...
SdkResponse ApiManager::listen(ReceiveOptions recvOptions,
...
SdkResponse ApiManager::accept(OpHandle handle,
                               std::function<void(ApiStatus, RaceHandle)> callback) {
    TRACE_METHOD();
...
SdkResponse ApiManager::read(OpHandle handle,
                             std::function<void(ApiStatus, std::vector<uint8_t>)> callback) {
    TRACE_METHOD();
...
SdkResponse ApiManager::write(OpHandle handle, std::vector<uint8_t> bytes,
    ...
    return post(logPrefix, &ApiManagerInternal::write, handle, std::move(bytes), callback);
}

SdkResponse ApiManager::close(OpHandle handle, std::function<void(ApiStatus)> callback) {
    TRACE_METHOD();
...
SdkResponse ApiManager::onStateMachineFailed(RaceHandle contextHandle) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onStateMachineFailed, contextHandle);
}

SdkResponse ApiManager::onStateMachineFinished(RaceHandle contextHandle) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onStateMachineFinished, contextHandle);
}

SdkResponse ApiManager::onConnectionStatusChanged(PluginContainer & /* plugin */, RaceHandle handle,
                                                  const ConnectionID &connId,
                                                  ConnectionStatus status,
                                                  const LinkProperties &properties) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onConnectionStatusChanged, handle, connId, status,
                properties);
}

SdkResponse ApiManager::onConnStateMachineConnected(RaceHandle contextHandle, ConnectionID connId,
                                                    std::string linkAddress) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onConnStateMachineConnected, contextHandle, connId,
                linkAddress);
}

SdkResponse ApiManager::onChannelStatusChangedForContext(RaceHandle contextHandle,
                                                         RaceHandle callHandle,
                                                         const ChannelId &channelGid,
                                                         ChannelStatus status,
                                                         const ChannelProperties &properties) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onChannelStatusChangedForContext, contextHandle,
                callHandle, channelGid, status, properties);
}

// Plugin callbacks
SdkResponse ApiManager::onChannelStatusChanged(PluginContainer & /* plugin */, RaceHandle handle,
                                               const ChannelId &channelGid, ChannelStatus status,
                                               const ChannelProperties &properties) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onChannelStatusChanged, handle, channelGid, status,
                properties);
}

SdkResponse ApiManager::onLinkStatusChanged(PluginContainer & /* plugin */, RaceHandle handle,
                                            const LinkID &linkId, LinkStatus status,
                                            const LinkProperties &properties) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onLinkStatusChanged, handle, linkId, status,
                properties);
}

SdkResponse ApiManager::receiveEncPkg(PluginContainer & /* plugin */, const EncPkg &pkg,
                                      const std::vector<ConnectionID> &connIDs) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::receiveEncPkg, pkg, connIDs);
}

SdkResponse ApiManager::onPackageStatusChanged(PluginContainer & /* plugin */, RaceHandle handle,
                                               PackageStatus status) {
    TRACE_METHOD();
    return post(logPrefix, &ApiManagerInternal::onPackageStatusChanged, handle, status);
}
...
void ApiManagerInternal::send(uint64_t postId, SendOptions sendOptions, std::vector<uint8_t> data,
...
void ApiManagerInternal::dial(uint64_t postId, SendOptions sendOptions, std::vector<uint8_t> data,
                              std::function<void(ApiStatus, RaceHandle)> callback) {
    TRACE_METHOD(postId, sendOptionsToString(sendOptions), data);
...
void ApiManagerInternal::receive(uint64_t postId, OpHandle handle,
                                 std::function<void(ApiStatus, std::vector<uint8_t>)> callback) {
...
void ApiManagerInternal::receiveRespond(
    ...
    std::function<void(ApiStatus, std::vector<uint8_t>, LinkAddress)> callback) {
    TRACE_METHOD(postId, handle);
    ...
    auto wrapperCallback = [callback, sendChannel, multiChannel](ApiStatus status,
                                                                 std::vector<uint8_t> data) {
        std::string logPrefix = "ApiManagerInternal::receiveRespondCallbackWrapper: ";
        ...
        try {
            ...
            // This can happen if a bad package is received. What's the proper behavior? Should
            // we ignore the package and retry the receive request?
            callback(ApiStatus::INTERNAL_ERROR, {}, "");
        }
    };
...
void ApiManagerInternal::listen(uint64_t postId, ReceiveOptions recvOptions,
                                std::function<void(ApiStatus, LinkAddress, RaceHandle)> callback) {
    TRACE_METHOD(postId, recvOptionsToString(recvOptions));
...
void ApiManagerInternal::accept(uint64_t postId, OpHandle handle,
                                std::function<void(ApiStatus, RaceHandle)> callback) {
    // API read receive connection - should call callback when a package is available
    TRACE_METHOD(postId, handle);
...
void ApiManagerInternal::read(uint64_t postId, OpHandle handle,
                              std::function<void(ApiStatus, std::vector<uint8_t>)> callback) {
    // API read receive connection - should call callback when a package is available
    TRACE_METHOD(postId, handle);
...
void ApiManagerInternal::write(uint64_t postId, OpHandle handle, std::vector<uint8_t> bytes,
                               std::function<void(ApiStatus)> callback) {
    // API read receive connection - should call callback when a package is available
    TRACE_METHOD(postId, handle);
...
void ApiManagerInternal::close(uint64_t postId, OpHandle handle,
                               std::function<void(ApiStatus)> callback) {
    // API close receive connection - should call callback after completing shutdown of link
    TRACE_METHOD(postId, handle);
...
//--------------------------------------------------------
ActivateChannelStatusCode ApiManagerInternal::activateChannel(ApiContext &context,
                                                              RaceHandle handle,
                                                              ChannelId channelId,
                                                              std::string role) {
    ...
    if (it != activatedChannels.end()) {
        ...
        SdkResponse response = manager.onChannelStatusChangedForContext(context.handle, handle,
                                                                        channelId, status, props);
...
void ApiManagerInternal::connStateMachineConnected(RaceHandle contextHandle, ConnectionID connId,
                                                   std::string linkAddress) {
    TRACE_METHOD(contextHandle, connId);
    manager.onConnStateMachineConnected(contextHandle, connId, linkAddress);
}

void ApiManagerInternal::onStateMachineFailed(uint64_t postId, RaceHandle contextHandle) {
...
void ApiManagerInternal::onStateMachineFinished(uint64_t postId, RaceHandle contextHandle) {
    TRACE_METHOD(postId, contextHandle);
...
void ApiManagerInternal::onConnStateMachineConnected(uint64_t postId, RaceHandle contextHandle,
                                                     ConnectionID connId, std::string linkAddress) {
    TRACE_METHOD(postId, contextHandle, connId);

    auto contexts = getContexts(contextHandle);
    for (auto context : contexts) {
        context->updateConnStateMachineConnected(contextHandle, connId, linkAddress);
        triggerEvent(*context, EVENT_CONN_STATE_MACHINE_CONNECTED);
    }
}

// This is triggered by activateChannel if onChannelStatusChanged was already called
void ApiManagerInternal::onChannelStatusChangedForContext(uint64_t postId, RaceHandle contextHandle,
                                                          RaceHandle callHandle,
                                                          const ChannelId &channelGid,
                                                          ChannelStatus status,
                                                          const ChannelProperties &properties) {
    ...
    ApiContext &context = *contextIt->second;
    context.updateChannelStatusChanged(callHandle, channelGid, status, properties);
...
// Plugin callbacks
//--------------------------------------------------------
void ApiManagerInternal::onChannelStatusChanged(uint64_t postId, RaceHandle chanHandle,
                                                const ChannelId &channelGid, ChannelStatus status,
                                                const ChannelProperties &properties) {
    ...
    for (auto context : contexts) {
        context->updateChannelStatusChanged(chanHandle, channelGid, status, properties);
        triggerEvent(*context, event);
    }
}

void ApiManagerInternal::onLinkStatusChanged(uint64_t postId, RaceHandle linkHandle,
                                             const LinkID &linkId, LinkStatus status,
                                             const LinkProperties &properties) {
...
void ApiManagerInternal::onConnectionStatusChanged(uint64_t postId, RaceHandle connHandle,
                                                   const ConnectionID &connId,
                                                   ConnectionStatus status,
                                                   const LinkProperties &properties) {
    ...
    for (auto context : contexts) {
        context->updateConnectionStatusChanged(connHandle, connId, status, properties);
        triggerEvent(*context, event);
    }
}

void ApiManagerInternal::receiveEncPkg(uint64_t postId, const EncPkg &pkg,
                                       const std::vector<ConnectionID> &connIDs) {
    TRACE_METHOD(postId, connIDs);
    // package received by plugin
    // called by SdkWrapper::receiveEncPkg() -> Core::receiveEncPkg() -> this->receiveEncPkg()
    ...
    if (contents->size() < packageIdLen) {
        ...
        std::vector<int> packageIdBytes{contents->begin(), contents->begin() + packageIdLen};
        ...
        if (it != packageIdContextMap.end()) {
            contexts = it->second;
            *contents = std::vector<uint8_t>(contents->begin() + packageIdLen, contents->end());
...
void ApiManagerInternal::onPackageStatusChanged(uint64_t postId, RaceHandle pkgHandle,
                                                PackageStatus status) {
    ...
    } else if (status == PACKAGE_FAILED_GENERIC || status == PACKAGE_FAILED_NETWORK_ERROR ||
...
RaceHandle ApiManagerInternal::startConnStateMachine(RaceHandle contextHandle, ChannelId channelId,
    ...
    context->updateConnStateMachineStart(contextHandle, channelId, role, linkAddress, sending);
...
RaceHandle ApiManagerInternal::startConnObjectStateMachine(
    ...
    TRACE_METHOD(contextHandle, recvHandle, recvConnId, sendChannel, recvChannel, sendHandle,
                 sendConnId);

    // create a connection context and copy information from the send/recv context
    auto context = newConnObjectContext();
    context->updateConnObjectStateMachineStart(contextHandle, recvHandle, recvConnId, sendHandle,
                                               sendConnId, sendChannel, recvChannel, packageId,
                                               std::move(recvMessages), apiHandle);
...
RaceHandle ApiManagerInternal::startPreConnObjStateMachine(
    RaceHandle contextHandle, RaceHandle recvHandle, const ConnectionID &recvConnId,
    const ChannelId &recvChannel, const ChannelId &sendChannel, const std::string &sendRole,
    ...
    context->updatePreConnObjStateMachineStart(contextHandle, recvHandle, recvConnId, recvChannel,
                                               sendChannel, sendRole, sendLinkAddress, packageId,
                                               recvMessages);
...
bool ApiManagerInternal::onListenAccept(RaceHandle contextHandle,
...
bool ApiManagerInternal::detachConnSM(RaceHandle contextHandle, RaceHandle connSMContextHandle) {
...
Core &ApiManagerInternal::getCore() {
    return core;
}

// register contexts
void ApiManagerInternal::registerHandle(ApiContext &context, RaceHandle handle) {
    TRACE_METHOD(context.handle, handle);
    handleContextMap[handle].insert(&context);
}

void ApiManagerInternal::registerId(ApiContext &context, const std::string &id) {
    TRACE_METHOD(context.handle, id);
    idContextMap[id].insert(&context);
}

void ApiManagerInternal::registerPackageId(ApiContext &context, const ConnectionID &connId,
                                           const std::string &id) {
    std::string packageId = json(std::vector<uint8_t>(id.begin(), id.end())).dump();
    TRACE_METHOD(context.handle, packageId);
    packageIdContextMap[id + connId].insert(&context);
}

void ApiManagerInternal::unregisterHandle(ApiContext &context, RaceHandle handle) {
    TRACE_METHOD(context.handle, handle);
...
ApiContext *ApiManagerInternal::newConnObjectContext() {
    auto newContext = std::make_unique<ConnectionObjectContext>(*this, connObjectEngine);
    auto handle = newContext->handle;
    activeContexts[handle] = (std::move(newContext));
    return activeContexts[handle].get();
}
...
ApiContext *ApiManagerInternal::newPreConnObjContext() {
    auto newContext = std::make_unique<PreConnObjContext>(*this, preConnObjEngine);
    auto handle = newContext->handle;
    activeContexts[handle] = (std::move(newContext));
    return activeContexts[handle].get();
}
...
ApiContext *ApiManagerInternal::newSendReceiveContext() {
    auto newContext = std::make_unique<ApiSendReceiveContext>(*this, sendReceiveEngine);
    auto handle = newContext->handle;
    activeContexts[handle] = (std::move(newContext));
    return activeContexts[handle].get();
}
...
ApiManagerInternal::Contexts ApiManagerInternal::getContexts(RaceHandle handle) {
...
ApiManagerInternal::Contexts ApiManagerInternal::getContexts(const std::string &id) {
    Contexts contexts;
...
ApiManagerInternal::Contexts ApiManagerInternal::getContextsByPackageId(
...
void ApiManagerInternal::removeContext(ApiContext &context) {
    TRACE_METHOD();
    for (auto pairIt = handleContextMap.begin(); pairIt != handleContextMap.end();) {
        pairIt->second.erase(&context);
    ...
    for (auto pairIt = packageIdContextMap.begin(); pairIt != packageIdContextMap.end();) {
        pairIt->second.erase(&context);
        if (pairIt->second.size() == 0) {
...
EventResult ApiManagerInternal::triggerEvent(ApiContext &context, EventType event) {
