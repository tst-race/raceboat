...
public:
    ...
    virtual void onChannelStatusChanged(RaceHandle handle, const ChannelId &channelGid,
                                        ChannelStatus status, const ChannelProperties &properties);
    virtual ActivateChannelStatusCode activateChannel(RaceHandle handle, std::string channelGid,
                                                      std::string roleName);
