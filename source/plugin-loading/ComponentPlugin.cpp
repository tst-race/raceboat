...
std::shared_ptr<ITransportComponent> ComponentPlugin::createTransport(
...
std::shared_ptr<IUserModelComponent> ComponentPlugin::createUserModel(
...
std::shared_ptr<IEncodingComponent> ComponentPlugin::createEncoding(
