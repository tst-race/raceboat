...
inline bool operator==(const PluginConfig &lhs, const PluginConfig &rhs) {
  return lhs.etcDirectory == rhs.etcDirectory &&
         lhs.loggingDirectory == rhs.loggingDirectory &&
         lhs.auxDataDirectory == rhs.auxDataDirectory &&
         lhs.tmpDirectory == rhs.tmpDirectory &&
