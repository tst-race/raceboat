...
/**
 * @brief Convert a ChannelRole value to a human readable string. This function
 * is strictly for logging and debugging. The output formatting may change
 * without notice. Do NOT use this for any logical comparisons, etc. The
