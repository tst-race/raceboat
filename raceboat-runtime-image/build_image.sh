...
# -----------------------------------------------------------------------------
# Build the RACE comm lib docker image
#
# Arguments:
# --platform-x86_64
...
#
# Example Call:
#    bash build_raceboat_image.sh {--version=2.6.0} {--platform-x86_64}
# -----------------------------------------------------------------------------
...
set -x
formatlog "INFO" "Building raceboat Image: ${IMAGE_NAMESPACE}raceboat:${IMAGE_VERSION}"
